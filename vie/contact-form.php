                                                    ...
                                                    <table class="twelve columns">
                                                        <tr>
                                                            ...
                                                            <td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
                                                                <span class="template-label">Обращение</span>
                                                            </td>
                                        ...
                                        <tr>
                                            <td class="wrapper last">
                                                <table class="twelve columns">
                                                    <tr>
                                                        <td>
                                                            <h3><?php echo $requestArr['subject']; ?></h3>
                                                            <p class="lead">письмо от: <?php echo $requestArr['name']; ?> </p>
                                                            <p><?php echo $requestArr['body']; ?> </p>
                                                        </td>
                                                        <td class="expander"></td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td class="wrapper last">
                                                <table class="twelve columns">
                                                    <tr>
                                                        <td class="panel">                                                       
                                                            <p >Телефон: <?php echo $requestArr['phone']; ?> </p>
                                                            <p >Email: <?php echo "<a href='mailto:".$requestArr['email']. "'>".$requestArr['email']; ?></a></p>
                                                                            ...
                                                                            <td class="wrapper last">
                                                                                <table class="twelve columns">
                                                                                    <tr>
                                                                                        <td align="center">
                                                                                            <center>
                                                                                                <p style="text-align:center;"><a href="#">Положение</a> | <a href="#">Права</a> | <a href="#">Переслать</a></p>
                                                                                            </center>
                                                                                        </td>
                                                                                        <td class="expander"></td>
                                                                                    </tr>
